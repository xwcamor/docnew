...
return [
    ...
    'index_title'    => 'Marcas',
    'index_subtitle' => 'Catálogo de marcas del workspace.',
    'create_title'   => 'Crear marca',
    'create_subtitle'=> 'Completa los datos para crear una marca nueva.',
    'edit_title'     => 'Editar marca',
    'delete_title'   => 'Eliminar marca',
    'show_title'     => 'Marca — Información',
    'trash_title'    => 'Papelera de marcas',
    'form_create_hint' => 'Completa los datos para crear una marca nueva.',
    'empty_hint'      => 'Crea la primera marca o importa un lote desde Excel para empezar.',
    'name_placeholder' => 'Ej: Acme, Globex, Contoso',

    'name'      => 'Nombre',
    'name_help' => 'Nombre de la marca (ej: Acme, Globex, Contoso).',
    'code'      => 'Código',
    'code_help' => 'Identificador corto para listados e importaciones (ej: acme, globex). Si lo dejas vacío se genera desde el nombre.',
    'sort_order' => 'Orden',
    'sort_order_help' => 'Número para ordenar el catálogo a mano: el más bajo va primero al ordenar por esta columna. Es opcional.',
    'sort_order_placeholder' => 'Ej: 10',
    'is_active' => 'Estado',
    'is_active_help' => 'Si está inactiva, la marca no aparecerá en los selectores de otros módulos.',
    'filter_name' => 'Nombre',
    ...
    'name_unique'              => 'Esta marca ya existe.',
    'code_unique'              => 'Ya existe una marca con este código.',
    ...
    'edit_all_subtitle' => 'Edita nombre y estado de muchas marcas a la vez. Pulsa "Guardar todo" para confirmar, "Descartar cambios" para deshacer.',
