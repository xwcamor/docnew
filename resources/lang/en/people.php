...
return [
    ...
    'index_title'    => 'People',
    'index_subtitle' => 'Global catalog of people used in diagnostics.',
    'create_title'   => 'Create person',
    'create_subtitle'=> 'Fill in the data to create a new person.',
    'edit_title'     => 'Edit person',
    'delete_title'   => 'Delete person',
    'show_title'     => 'Person — Details',
    'trash_title'    => 'People trash',
    'form_create_hint' => 'Fill in the data to create a new person.',
    'empty_hint'      => 'Create your first person or import a batch from Excel.',
    'name_placeholder' => 'E.g.: Acme, Globex, Contoso',

    'name'      => 'Name',
    'name_help' => 'Person name (e.g. Acme, Globex, Contoso).',
    'num_doc'      => 'Code',
    'code_help' => 'Internal technical identifier (e.g. mineral, silicone, vegetable_soy).',
    'lastname' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the person will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'code_unique'              => 'An person with this code already exists.',
    ...
    'edit_all_subtitle' => 'Edit name and status of multiple people at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'tour' => [
        ...
        'step1_body'  => 'This is the people catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',
