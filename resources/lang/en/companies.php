...
return [
    ...
    'index_subtitle' => 'Global catalog of companies used in diagnostics.',
    'create_title'   => 'Create company',
    'create_subtitle'=> 'Fill in the data to create a new company.',
    ...
    'name'      => 'Name',
    'name_help' => 'Company name (e.g. Acme, Globex, Contoso).',
    'num_doc'      => 'Code',
    'code_help' => 'Internal technical identifier (e.g. mineral, silicone, vegetable_soy).',
    'complete_name' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the company will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'code_unique'              => 'An company with this code already exists.',
    ...
    'tour' => [
        ...
        'step1_body'  => 'This is the companies catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',
