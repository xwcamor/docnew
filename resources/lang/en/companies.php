...
return [
    ...
    'complete_name_help'       => 'The legal name, exactly as it appears on the tax document. Where an official lookup exists, it is filled in automatically.',
    ...
    'razon_esperando_doc'      => 'Filled in once you type the :type.',
    'razon_de_sunat'           => 'Legal name from the tax authority.',
    'razon_editar_a_mano'      => 'Edit by hand',
    'document'                 => 'Document',
    'doc_type'                 => 'Document type',
    'doc_type_help'            => 'Which document the company carries in its country. It comes from the document types catalogue.',
    ...
    'filter_name'              => 'Name, legal name or document',
    'search_placeholder'       => 'Search by name, legal name or document…',
    ...
    // Import errors: the document column is NOT NULL in the table, so an empty
    // cell can never reach the database. The file carries companies from several
    // countries on the same sheet, so there is no single abbreviation to name.
    'import_err_num_doc_required' => 'The document number is missing. It is required to create a company.',
    'import_err_num_doc_too_long' => 'The document number exceeds 20 characters.',
