...
return [
    ...
    'index_title'    => 'Brands',
    'index_subtitle' => 'Brand catalog for this workspace.',
    ...
    'code'      => 'Code',
    'code_help' => 'Short identifier for lists and imports (e.g. acme, globex). Left empty, it is derived from the name.',
    'sort_order' => 'Order',
    'sort_order_help' => 'Number to order the catalog by hand: lowest goes first when sorting by this column. Optional.',
    ...
    'code_unique'              => 'A brand with this code already exists.',
    ...
    'edit_all_subtitle' => 'Edit name and status of multiple brands at once. Click "Save all" to confirm, "Discard changes" to undo.',
