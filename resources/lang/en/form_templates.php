...
return [
    ...
    'index_title'    => 'FormTemplates',
    'index_subtitle' => 'Global catalog of form_templates used in diagnostics.',
    'create_title'   => 'Create formTemplate',
    'create_subtitle'=> 'Fill in the data to create a new formTemplate.',
    'edit_title'     => 'Edit formTemplate',
    'delete_title'   => 'Delete formTemplate',
    'show_title'     => 'FormTemplate — Details',
    'trash_title'    => 'FormTemplates trash',
    'form_create_hint' => 'Fill in the data to create a new formTemplate.',
    ...
    'publish_empty' => 'A document with fields cannot be published empty: add at least one field first.',
    'status_draft' => 'Draft',
    ...
    'version' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the formTemplate will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'export_filename'           => 'form_templates_export',
    'import_template_filename'  => 'form_templates-template.xlsx',
    'export_title'              => 'FormTemplates Report',
    ...
    'name_unique'              => 'This formTemplate already exists.',
    'code_unique'              => 'An formTemplate with this code already exists.',
    ...
    'edit_all_title'    => 'FormTemplates — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple form_templates at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No form_templates match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to FormTemplates',
        'step1_body'  => 'This is the form_templates catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',
