...
return [
    ...
    'index_title'    => 'WorkPlans',
    'index_subtitle' => 'Global catalog of work_plans used in diagnostics.',
    'create_title'   => 'Create workPlan',
    'create_subtitle'=> 'Fill in the data to create a new workPlan.',
    'edit_title'     => 'Edit workPlan',
    'delete_title'   => 'Delete workPlan',
    'show_title'     => 'WorkPlan — Details',
    'trash_title'    => 'WorkPlans trash',
    'form_create_hint' => 'Fill in the data to create a new workPlan.',
    'empty_hint'      => 'Create your first workPlan or import a batch from Excel.',
    'name_placeholder' => 'E.g.: Acme, Globex, Contoso',

    'name'      => 'Name',
    'name_help' => 'WorkPlan name (e.g. Acme, Globex, Contoso).',
    'code'      => 'Code',
    'code_help' => 'Internal technical identifier (e.g. mineral, silicone, vegetable_soy).',
    'num_os' => 'Order',
    'is_active' => 'Status',
    'is_active_help' => 'If inactive, the workPlan will not appear in selectors of other modules.',
    'filter_name' => 'Name',
    ...
    'created' => 'WorkPlan created.',
    'saved'   => 'WorkPlan updated.',
    'deleted' => 'WorkPlan deleted.',
    ...
    'import_template_filename'  => 'work_plans-template.xlsx',
    'export_title'              => 'WorkPlans Report',
    ...
    'name_unique'              => 'This workPlan already exists.',
    'code_unique'              => 'An workPlan with this code already exists.',
    ...
    'edit_all_title'    => 'WorkPlans — Edit All',
    'edit_all_subtitle' => 'Edit name and status of multiple work_plans at once. Click "Save all" to confirm, "Cancel" to discard.',
    ...
    'edit_all_no_results' => 'No work_plans match the filter.',
    ...
    'tour' => [
        'step1_title' => 'Welcome to WorkPlans',
        'step1_body'  => 'This is the work_plans catalog. Quick tour in under a minute.',
        'step2_title' => 'Filters',
