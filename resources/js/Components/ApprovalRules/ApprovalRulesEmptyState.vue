...
import { NodeIndexOutlined, PlusOutlined, UploadOutlined } from '@ant-design/icons-vue';
        ...
        <Space wrap>
            ...
            <template v-if="!hasFilters && canCreate">
                <Link :href="route('business_management.approval_rules.create')">
                    <Button type="primary">
                        <PlusOutlined /> {{ $t('approval_rules.new') }}
                    </Button>
                </Link>
