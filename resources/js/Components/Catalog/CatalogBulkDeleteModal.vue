<script setup>
/**
 * Confirmación del borrado masivo de un catálogo.
 *
 * El motivo es obligatorio y no decorativo: un catálogo de obra puede acabar
 * citado en un plan que ve un inspector, y «quién lo quitó y por qué» tiene que
 * quedar escrito (docs/UI.md §6).
 */
...
<template>
    <Modal
        ...
        @ok="emit('confirm')"
    >
        <p class="bulk-msg">{{ $t('global.about_to_delete', { count, resource: resourceLabel }) }}</p>
