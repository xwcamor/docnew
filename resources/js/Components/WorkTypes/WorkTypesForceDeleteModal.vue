<script setup>
/**
 * Borrado definitivo, con tres cierres: hay que teclear el código del tipo (es
 * lo que lo identifica a ojo en la papelera y lo único que el usuario
 * reconoce), el motivo es obligatorio y de al menos 10 caracteres, y solo el
 * super llega hasta aquí.
 */
