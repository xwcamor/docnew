...
/**
 * Columnas de la tabla principal de FormTemplates.
 *
...
export const formTemplatesTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    ...
    { title: t('form_templates.is_active'), dataIndex: 'is_active',   key: 'status',     width: 150, sorter: (a, b) => Number(a.is_active) - Number(b.is_active), mobile: { role: 'status' } },
