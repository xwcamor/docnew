 ...
 */
export const formTemplatesTrashColumns = (t) => [
    { title: 'ID',                           dataIndex: 'id',                  key: 'id',          width: 80,  mobile: { role: 'meta' } },
    { title: t('form_templates.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('form_templates.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
