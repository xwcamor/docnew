/**
 * Columnas de la papelera: quién borró, cuándo y por qué — que es justo lo
 * que no se ve en el listado principal.
 */
export const approverRolesTrashColumns = (t) => [
    { title: t('approver_roles.code'),       dataIndex: 'code',                key: 'code',       width: 180, mobile: { role: 'title' } },
    { title: t('approver_roles.name_es'),    dataIndex: 'name_es',             key: 'name_es',    ellipsis: true, mobile: { role: 'subtitle' } },
