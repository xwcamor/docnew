 ...
 */
export const workAreasTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    { title: t('work_areas.name'), dataIndex: 'name', key: 'name', sorter: true, alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('work_areas.country'), dataIndex: ['country', 'name'], key: 'country', width: 180, mobile: { role: 'subtitle' } },
    { title: t('work_areas.usage_count'), dataIndex: 'usage_count', key: 'usage_count', width: 190, align: 'center', mobile: { role: 'meta' } },
    ...(isSuper ? [
        { title: t('tenants.singular'), dataIndex: ['tenant', 'name'], key: 'tenant', width: 180, sorter: true, mobile: { role: 'meta', icon: ApartmentOutlined } },
    ] : []),
    { title: t('work_areas.is_active'), dataIndex: 'is_active', key: 'status', width: 130, sorter: true, mobile: { role: 'status' } },
