...
/**
 * Columnas del listado de nacionalidades.
 *
 ...
 */
export const nationalitiesTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    { title: t('nationalities.code'), dataIndex: 'code', key: 'code', sorter: true, alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('nationalities.country'), dataIndex: ['country', 'name'], key: 'country', width: 180, mobile: { role: 'subtitle' } },
    { title: t('nationalities.usage_count'), dataIndex: 'usage_count', key: 'usage_count', width: 190, align: 'center', mobile: { role: 'meta' } },
    ...(isSuper ? [
        { title: t('tenants.singular'), dataIndex: ['tenant', 'name'], key: 'tenant', width: 180, sorter: true, mobile: { role: 'meta', icon: ApartmentOutlined } },
    ] : []),
    { title: t('nationalities.is_active'), dataIndex: 'is_active', key: 'status', width: 130, sorter: true, mobile: { role: 'status' } },
