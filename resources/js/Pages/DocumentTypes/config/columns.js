...
export const document_typesTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    { title: t('document_types.code'), dataIndex: 'code', key: 'code', sorter: true, alwaysVisible: true, mobile: { role: 'title' } },
    { title: t('document_types.country'), dataIndex: ['country', 'name'], key: 'country', width: 180, mobile: { role: 'subtitle' } },
