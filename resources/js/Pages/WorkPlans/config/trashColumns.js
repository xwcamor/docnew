...
export const workPlansTrashColumns = (t) => [
    ...
    { title: t('work_plans.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('work_plans.code'),            dataIndex: 'code',                key: 'code',        width: 140, mobile: { role: 'meta' } },
