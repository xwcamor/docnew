...
export const workPlansTableColumns = (t, { isSuper = false, isMobile = false } = {}) => [
    ...
    // Lo que se lee de verdad al buscar un plan: de qué iba, dónde fue y cuándo
    // acabó. Estaban las cuatro escritas y ocultas por defecto, y para verlas
    // había que ir al selector de columnas — o sea que nadie las veía.
    { title: t('work_plans.description'),    dataIndex: 'description', key: 'description',   width: 320, ellipsis: true, mobile: { role: 'subtitle' } },
    { title: t('work_plans.work_location'),  key: 'work_location',     width: 190, sorter: true, mobile: { role: 'meta', icon: EnvironmentOutlined } },
    { title: t('work_plans.workstation'),    key: 'workstation',       width: 170, mobile: { role: 'meta', icon: BlockOutlined } },
    { title: t('work_plans.date_end'),       dataIndex: 'date_end',    key: 'date_end',      width: 130, sorter: true, mobile: { role: 'meta', icon: CalendarOutlined } },
