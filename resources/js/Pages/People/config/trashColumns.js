...
export const peopleTrashColumns = (t) => [
    ...
    { title: t('people.name'),            dataIndex: 'name',                key: 'name',        ellipsis: true, mobile: { role: 'title' } },
    { title: t('people.num_doc'),            dataIndex: 'num_doc',                key: 'num_doc',        width: 140, mobile: { role: 'meta' } },
