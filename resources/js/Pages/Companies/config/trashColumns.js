...
export const companiesTrashColumns = (t) => [
    ...
    { title: t('companies.complete_name'),   dataIndex: 'complete_name',       key: 'complete_name', ellipsis: true, mobile: { role: 'subtitle' } },
    { title: t('companies.num_doc'),         dataIndex: 'num_doc',             key: 'num_doc',     width: 160, mobile: { role: 'meta' } },
