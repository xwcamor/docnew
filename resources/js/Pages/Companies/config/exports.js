 ...
 * ve únicamente empresas de su propio tenant. El backend lo gatea igual
...
export const companiesExportableColumns = (t, { isSuper = false } = {}) => [
    ...
    { key: 'country',          label: t('companies.country'),       default: true  },
    { key: 'people_count',     label: t('companies.people_count'),  default: false },
    { key: 'work_plans_count', label: t('companies.plans_count'),   default: false },
