...
if (!isSuper) {
    router.visit(route('business_management.companies.index'));
}
...
const {
    ...
    restoreRouteName:     'business_management.companies.restore',
    bulkRestoreRouteName: 'business_management.companies.bulk_restore',
});
...
const submitForceDelete = () => {
    ...
    forceDeleteErrors.value = {};
    router.delete(
        route('business_management.companies.force_delete', forceDeleteTarget.value.slug),
        {
