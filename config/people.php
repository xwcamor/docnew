...
/*
|--------------------------------------------------------------------------
| People module — tunable knobs
|--------------------------------------------------------------------------
|
| Clon de config/regions.php adaptado al modulo People (per-tenant).
...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('PEOPLE_EXPORT_LIMIT_CSV',   0),
        'excel' => env('PEOPLE_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('PEOPLE_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('PEOPLE_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('PEOPLE_EXPORT_MEMORY', '512M'),
];
