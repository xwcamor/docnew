...
/*
|--------------------------------------------------------------------------
| ApproverRoles module — tunable knobs
|--------------------------------------------------------------------------
|
| Catalogo de quien puede firmar. Es una tabla corta por naturaleza (unos
| pocos roles por workspace), asi que los topes son holgados a proposito:
| lo que se ajusta aqui es el techo, no el uso esperado.
*/
return [
    /**
     ...
     */
    'export_limits' => [
        'csv'   => env('APPROVER_ROLES_EXPORT_LIMIT_CSV',   0),
        'excel' => env('APPROVER_ROLES_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('APPROVER_ROLES_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('APPROVER_ROLES_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('APPROVER_ROLES_EXPORT_MEMORY', '512M'),
];
