...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('BRANDS_EXPORT_LIMIT_CSV',   0),
        'excel' => env('BRANDS_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('BRANDS_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('BRANDS_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('BRANDS_EXPORT_MEMORY', '512M'),
];
