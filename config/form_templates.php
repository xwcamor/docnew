...
/*
|--------------------------------------------------------------------------
| FormTemplates module — tunable knobs
|--------------------------------------------------------------------------
|
| Clon de config/regions.php adaptado al modulo FormTemplates (per-tenant).
...
return [
     ...
     */
    'export_limits' => [
        'csv'   => env('FORM_TEMPLATES_EXPORT_LIMIT_CSV',   0),
        'excel' => env('FORM_TEMPLATES_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('FORM_TEMPLATES_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('FORM_TEMPLATES_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('FORM_TEMPLATES_EXPORT_MEMORY', '512M'),
];
