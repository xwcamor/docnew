...
/*
|--------------------------------------------------------------------------
| ApprovalRules module — tunable knobs
|--------------------------------------------------------------------------
|
| Las reglas del flujo son pocas por definicion —un puñado por pais y tipo de
| trabajo—, asi que estos topes son techo, no expectativa.
*/
return [
    /**
     ...
     */
    'export_limits' => [
        'csv'   => env('APPROVAL_RULES_EXPORT_LIMIT_CSV',   0),
        'excel' => env('APPROVAL_RULES_EXPORT_LIMIT_EXCEL', 25000),
        'pdf'   => env('APPROVAL_RULES_EXPORT_LIMIT_PDF',   5000),
        'word'  => env('APPROVAL_RULES_EXPORT_LIMIT_WORD',  10000),
    ],
     ...
     */
    'export_job_memory_limit' => env('APPROVAL_RULES_EXPORT_MEMORY', '512M'),
];
