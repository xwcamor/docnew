...
class BulkDeleteWorkTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:work_types.delete ya gatea la ruta — este
        // authorize() esta aquí por consistencia con el patron FormRequest.
        return $this->user()?->can('work_types.delete') ?? false;
    }
