...
class BulkDeleteWorkAreaRequest extends FormRequest
{
    public function authorize(): bool
    {
        // El middleware permission:work_areas.delete ya gatea la ruta — este
        // authorize() esta aqui por consistencia con el patron FormRequest.
        return $this->user()?->can('work_areas.delete') ?? false;
    }
